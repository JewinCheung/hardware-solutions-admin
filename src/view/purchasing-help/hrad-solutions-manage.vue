        ...
        <Row :gutter="10" style="margin-bottom: 10px;">
          ...
          <Card>
            <div style="margin-bottom: 10px;">
              产品线：
              <Select style="width:160px" v-model="ProLineInfo.value" @on-change="proChange" :label-in-value="true">
                <Option v-for="item in ProLine" :value="item.DictNo" :key="item.DictNo">{{ item.DictName }}</Option>
              </Select>
