  ...
  <Layout style="height: 100%" class="main">
    <Sider hide-trigger collapsible :width="256" :collapsed-width="64" v-model="collapsed">
      <side-menu accordion :active-name="$route.name" :collapsed="collapsed" @on-select="turnToPage" :menu-list="menuList">
        ...
        <div class="logo-con">
          <img v-show="!collapsed" src="http://e.mdsd.cn:9000/Image/logo/logo170x50.png" class="max-logo" key="max-logo" />
          <img v-show="collapsed" src="http://e.mdsd.cn:9000/favicon.ico" class="min-logo" key="min-logo" />
        </div>
      </side-menu>
    </Sider>
    <Layout>
