      ...
      <div>
        <Form ref="infoForm" :model="infoForm" :label-width="100" inline>
          <FormItem label="标题" prop="infoTitle" style="width:90%">
            <Input v-model="infoForm.infoTitle"></Input>
          </FormItem>
          <FormItem label="医院名称" prop="hospName" style="width:45%">
            <Input v-model="infoForm.hospName"></Input>
          </FormItem>
          ...
          <FormItem label="应用科室" prop="hospDept" style="width:45%">
            <Input v-model="infoForm.hospDept"></Input>
          </FormItem>
          <FormItem label="供应商联系人" prop="supplierContact" style="width:45%">
            <Input v-model="infoForm.supplierContact"></Input>
          </FormItem>
          <FormItem label="场景描述" prop="infoDetail" style="width:90%">
            <Input v-model="infoForm.infoDetail" type="textarea" :autosize="{minRows: 5,maxRows: 10}" placeholder="提出硬件使用的场景（硬件安装的系统、使用场景、使用人员等）"></Input>
          </FormItem>
        </Form>
